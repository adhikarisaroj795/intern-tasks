...
const Services = () => {
  return (
    <>
        ...
        <div className="container">
          <div className="about-us-heading">
            <h1 className="about-h1">
              SHEET METAL, 3D PRINTING, <br /> AND CNC MACHINING SERVICE
            </h1>
          </div>
        </div>
      </div>
      ...
      <section className="fabrication-prototyping-sec m-t-70">
        <div className="container">
          <div className="fab-prot-holder">
            ...
            <div className="fab-prot-cards pd-btm-20 flex">
            ...
            <div className="fab-prot-title mx-wd-800">
              <p>
                At our company, we offer top-notch fabrication and prototyping
                services for our clients. With our state-of-the-art machinery
                and skilled technicians, we are equipped to handle even the most
                complex projects. Whether you need a simple bracket or a fully
                assembled product, our team is here to bring your designs to
                life. Our focus on quality and attention to detail ensures that
                your finished product will meet or exceed your expectations.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="why-choose-monster pd-b-20">
        <div className="container">
          <div className="fab-prot-title whychoose-mon mx-wd-800">
            <h2 className="h2-heading">INDUSTRY-SPECIFIC SOLUTIONS</h2>
            <p className="mr-top-40">
              We provide industry-specific solutions to meet the unique needs of
              different industries. We are highly experienced in serving a range
              of industries, including Automobile, Aerospace, Industrial
              Robotics, School Lab, Medical, Smart Appliances, Electronic
              Appliances, and Automation. We use advanced fabrication techniques
              and state-of-the-art equipment to manufacture precision parts and
              components of the highest quality. Whether you need prototypes,
              one-off parts, or high-volume production runs, we are ready to
              support your needs with a comprehensive range of services. Contact
      ...
      <section className="how-it-works">
        <div className="container">
          <div className="fab-prot-title whychoose-mon mx-wd-800 rapid-proto">
            <h2 className="h2-heading">RAPID PROTOTYPE DEVELOPMENT</h2>
            <p>
              Our team is dedicated to providing rapid prototype development
              services that streamline the process and get your prototypes up
              and running quickly. Our expertise in 3D printing, CNC machining,
              and sheet metal fabrication allows us to produce prototypes that
              are not only accurate and efficient, but also high quality and
              cost-effective. Whether you’re in the automotive, aerospace,
              medical, or electronics industry, we have the knowledge and
              resources to create prototypes that meet your unique requirements.
              With us, you can rest assured that you will receive the best
              prototype development and fabrication services available. We look
          ...
          <div className="three-col-choose">
            <div className="three-col-solo-why">
              ...
              <div className="how-works-details">
                ...
                <p>Whatsapp or Email your drawings</p>
              </div>
            </div>
            ...
            <div className="three-col-solo-why">
              ...
              <div className="how-works-details">
                ...
                <p>Receive quotation within 24 hours</p>
              </div>
            </div>
            <span className="box-icon">
              <i className="bx bx-right-arrow-alt"></i>
            ...
            <div className="three-col-solo-why">
              ...
              <div className="how-works-details">
                ...
                <p>
                  Once the quote is approved, we proceed with fabrication and
                  deliver within 10 working days
                </p>
              </div>
            </div>
          </div>
